...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        # 初始化界面
        super().__init__()
        self.setWindowTitle('基于Unet++的脑白质分割系统')
        # self.setStatusTip("")
        ...
        # 加载模型参数
        net.load_state_dict(torch.load('best_model_unetpp_my.pth', map_location=device))  # todo 模型位置
        # 测试模式
        net.eval()
        self.model = net
        self.initUI()
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        self.webcam_detection_btn = QPushButton("")
